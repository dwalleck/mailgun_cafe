...
def print_cafe_mug():
    print('\n'.join(["\t\t   _ _ _",
                     ...
                     "\t\t=== MailgunCAFE ==="]))
    print("========================================================")
    print("MailgunCAFE Framework installed")
    print("========================================================")
...
setup(
    ...
    version='0.0.1',
    description=(
        'MailgunCAFE is an implementation of the OpenCAFE Framework '
        'specifically designed to test deployed versions of Mailgun'),
    long_description='{0}\n\n{1}'.format(
        open('README.md').read(),
